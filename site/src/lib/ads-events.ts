...
export function bindAdsEvents(): void {
  document.addEventListener("click", (e) => {
    ...
    window.fbq?.("track", "Purchase", { content_name: `download_${platform}`, value: 39.99, currency: "EUR" })
    window.ttq?.track("CompletePayment", { content_name: `download_${platform}`, value: 39.99, currency: "EUR" })
  })
}
